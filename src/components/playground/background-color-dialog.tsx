...
export function BackgroundColorDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-2xl leading-none tracking-tight">Customize background</DialogTitle>
          <DialogDescription className="text-sm text-zinc-500 dark:text-zinc-400">
            Customize the background color of the form with colors from the Tailwind CSS palette.
          </DialogDescription>
        </DialogHeader>
