...
import { BooleanFieldFormat, BooleanFieldFormatSchema } from "@/core/types";
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>The description will be displayed below the field.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <div className="space-y-2.5">
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg">
                <div className="space-y-1">
                  ...
                  <FormDescription>
                    Boolean fields can be rendered as a card — which will add a border and padding.
                  </FormDescription>
                </div>
                <FormControl>
          ...
          <div className="flex h-40 w-full items-center justify-center rounded-sm bg-slate-100 p-8">
            <div className="flex flex-row items-start space-y-0 space-x-3 rounded-md border border-zinc-200 bg-white p-4">
              <Checkbox
                className="cursor-default data-[state=checked]:border-slate-200 data-[state=checked]:bg-slate-200 data-[state=checked]:text-zinc-900"
                checked
              />
              <div className="space-y-1 leading-none">
                ...
                <p className="text-sm text-zinc-500 select-none dark:text-zinc-400">Looks great, right?</p>
              </div>
            </div>
          </div>
        </div>
