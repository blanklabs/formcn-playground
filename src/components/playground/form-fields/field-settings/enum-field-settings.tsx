...
import { EnumFieldFormat, EnumFieldFormatSchema } from "@/core/types";
          ...
          <ul className="space-y-2">
            {optionFields.map((optionField, index) => (
              <li key={optionField.id} className="flex items-center space-x-2">
                <FormControl>
                  <Input placeholder="Name" {...form.register(`options.${index}.name`)} />
                </FormControl>
                <FormControl>
                  <Input placeholder="Value" {...form.register(`options.${index}.value`)} />
                </FormControl>
                <Button
                  type="button"
