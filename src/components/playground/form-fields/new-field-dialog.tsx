      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="flex h-[80vh] flex-col overflow-y-scroll px-0 sm:max-w-[768px]">
          <DialogHeader className="gap-1.5 px-6">
            <DialogTitle className="text-2xl leading-none tracking-tight">Add new field</DialogTitle>
            <DialogDescription>What field would you like to add to your form?</DialogDescription>
          </DialogHeader>
      ...
      <DrawerContent>
        <div className="mt-2 overflow-y-scroll">
          <DrawerHeader className="text-left">
            <DrawerTitle className="text-2xl leading-none tracking-tight">Add new field</DrawerTitle>
            <DrawerDescription>What field would you like to add to your form?</DrawerDescription>
          </DrawerHeader>
          <FormFieldSearchableList closeDialog={closeDialog} />
        </div>
      </DrawerContent>
