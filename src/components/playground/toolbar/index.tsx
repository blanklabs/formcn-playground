...
import { CornerDownRight, LetterText, Paintbrush, PaintBucket, SquareX, TextCursorInput, Trash2 } from "lucide-react";
...
export function Toolbar() {
  ...
  return (
    <div
      ref={ref}
      className={cn("mb-3 flex justify-between gap-1 rounded-lg", compactToolbar && "flex-col items-end gap-1.5")}
    >
      ...
      <AlertDialog open={clearFormDialogOpen} onOpenChange={setClearFormDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              If you clear the form, all the fields will be removed. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
