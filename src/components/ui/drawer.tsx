  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full bg-zinc-100 group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-zinc-800" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
